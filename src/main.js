...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function update3DView(productIndex) {
        ...
        productName3D.textContent = product.name_ua; addToCart3DBtn.textContent = 'Додати';
    }
